...
class SalesController extends AbstractController
{
    ...
    /**
     * @Route("/customer/{id}", name="customer_sales", methods={"GET"})
     */
    public function sales(int $id, SalesRepository $salesRepository): Response
    {
        $salesBycustomer = $salesRepository->findSalesByCustomer($id);
